...
public class AdminDevletUniversiteController {
                        ...
                        public void updateItem(String item, boolean empty) {
                            ...
                            if (empty) {
                                ...
                                delete.setOnAction(event -> {
                                    ...
                                    service.deleteFile(service.getPath() + "devlet"+ File.separator+model.getFileName());
                                    service.deleteFile(service.getPath() + "devlet"+File.separator+model.getFileName()+".png");
                                    fillTable();
                                });
    ...
    public void fillTable(){
        ...
        table.getItems().addAll(service.fileList("devlet"));
    }


    @FXML
    void ekle(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/layout/devletuniversiteekle.fxml"));
    ...
    void kaydet(ActionEvent event) throws IOException {
        TextData data = new TextData(new SimpleStringProperty("devlet"+ File.separator+fileName.getText()),
                new SimpleStringProperty(text.getText()), new SimpleStringProperty(""));
        DataService service = new DataService();
        service.writeFile(data);
        String src = imagePath.getText();
        String dst = service.getPath()+"devlet"+File.separator+fileName.getText()+".png";
