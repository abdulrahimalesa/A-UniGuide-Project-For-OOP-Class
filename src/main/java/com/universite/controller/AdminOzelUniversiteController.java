...
public class AdminOzelUniversiteController {
                        ...
                        public void updateItem(String item, boolean empty) {
                            ...
                            if (empty) {
                                ...
                                delete.setOnAction(event -> {
                                    ...
                                    service.deleteFile(service.getPath() + "ozel"+File.separator+model.getFileName());
                                    service.deleteFile(service.getPath() + "ozel"+File.separator+model.getFileName()+".png");
                                    fillTable();
                                });
    ...
    public void fillTable(){
        ...
        table.getItems().addAll(service.fileList("ozel"));
    }

    @FXML
    void kaydet(ActionEvent event) throws IOException {
        TextData data = new TextData(new SimpleStringProperty("ozel"+ File.separator+fileName.getText()), new SimpleStringProperty(text.getText()), new SimpleStringProperty(""));
        DataService service = new DataService();
        service.writeFile(data);
        String src = imagePath.getText();
        String dst = service.getPath()+"ozel"+File.separator+fileName.getText()+".png";
    ...
    void ekle(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/layout/ozeluniversiteekle.fxml"));
