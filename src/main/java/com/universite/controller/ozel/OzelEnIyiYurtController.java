...
public class OzelEnIyiYurtController {
    ...
    public void initialize(){
        ...
        fillData(service.fileList("ozelyurt"));
    }
    ...
    public void fillData(ObservableList<TextData> dList){
        ...
        for(TextData td : dList){
            ...
            File file = new File(service.getPath()+"ozelyurt"+File.separator+td.getFileName()+".png");
    ...
    public void openDetay(ActionEvent e) {
        try {
            fxUtil.redirect(e, "/layout/ozel/eniyiyurtdetay.fxml");
