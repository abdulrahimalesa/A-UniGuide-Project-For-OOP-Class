...
public class DevletEnIyiController {
    ...
    public void initialize(){
        ...
        fillData(service.fileList("devlet"));
    }
    ...
    public void fillData(ObservableList<TextData> dList){
        ...
        for(TextData td : dList){
            ...
            File file = new File(service.getPath()+"devlet"+File.separator+td.getFileName()+".png");
    ...
    public void openDetay(ActionEvent e) {
        try {
            fxUtil.redirect(e, "/layout/devlet/eniyidetay.fxml");
