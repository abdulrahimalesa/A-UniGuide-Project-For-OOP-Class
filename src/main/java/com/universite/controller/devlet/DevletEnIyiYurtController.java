...
public class DevletEnIyiYurtController {
    ...
    public void initialize(){
        ...
        fillData(service.fileList("devletyurt"));
    }
    ...
    public void fillData(ObservableList<TextData> dList){
        ...
        for(TextData td : dList){
            ...
            File file = new File(service.getPath()+"devletyurt"+File.separator+td.getFileName()+".png");
    ...
    public void openDetay(ActionEvent e) {
        try {
            fxUtil.redirect(e, "/layout/devlet/eniyiyurtdetay.fxml");
